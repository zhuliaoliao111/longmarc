...
Page({
  data: {
    artifact: null,
    isPlaying: false,
    vrUrl: 'https://vr.81.cn/H5/jb/81/index.html',
    artifactImageUrl: '',
    pauseIconUrl: '',
    speakerIconUrl: ''
  },
  ...
  initAudio: function(audioUrl) {
    ...
    // 直接使用音频URL，不通过AudioManager的复杂逻辑
  ...
  openVR: function() {
    wx.navigateTo({
      url: `../vr/vr?url=${encodeURIComponent(this.data.vrUrl)}`
    });
  },
  toggleExpand() {
    this.setData({
